	    		...
	    		<div class="collapse navbar-collapse" id="navbarText">
		      		<ul class="navbar-nav me-auto mb-2 mb-lg-0">
		        		<li class="nav-item">
		          			...
		          			<a class="nav-link" ng-href="#/">OFICINAS</a>
		        		
		        		</li>

		        		<li class="nav-item">

		        			<a class="nav-link" ng-href="#/especialitats/1">Especialitats</a>

		        		</li>

		        		<li class="nav-item">
		        			
		        			<a class="nav-link" ng-href="#/edicions/2">ediciones</a>

		        		</li>
						<li class="nav-item">
		        			
		        			<a class="nav-link" ng-href="#/districtes">Districtos</a>

		        		</li>

		        		<li class="nav-item">
		        			
		        			<a class="nav-link" ng-href="#/multimedia/3">Multimedia</a>
